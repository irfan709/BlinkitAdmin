...
import com.example.blinkitadmin.databinding.FragmentOtpVerificationBinding
import com.example.blinkitadmin.models.UserModel
...
class OtpVerificationFragment : Fragment() {
    ...
    private fun verifyOtpAndSignIn(enteredOtp: String) {
        val user =
            UserModel(uid = Utils.getCurrentUserId(), phoneNumber = phoneNumber)
        authViewModel.apply {
